...
func main() {
	...
	// newEmail := createEmail(client, "newguy@test.com")
	// newEmail.ConfirmedAt = 10000
	createEmail(client, "test2@test.com")
	createEmail(client, "hmm@test.com")
	createEmail(client, "testing@haha.com")
	// createEmail(client, "ml@gmail.com")
